...
import specialSvg from '../assets/special.svg';

interface EffectOverlayProps {
  scene: SceneState;
}

export const EffectOverlay: React.FC<EffectOverlayProps> = ({ scene }) => {
  if (scene === 'ATTACK') {
    return (
  ...
  if (scene === 'SPECIAL') {
    return (
      <div className="effect-overlay effect-special">
        <img src={specialSvg} alt="" className="effect-img effect-special-img" />
